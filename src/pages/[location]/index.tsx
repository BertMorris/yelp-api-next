...
export default function Cuisines({}: Props) {
  ...
  return (
    <div className="cuisine__chooser">
      ...
      <select id="radius" name="radius" value={selectedRadius} onChange={handleRadiusChange}>
      ...
      <input type="text" id="location" name="location" placeholder="e.g. New York City" value={location} onChange={handleLocationChange} />
    </form>
    ...
    <div className="App">
      ...
      <div className="button-group">
        <button className={`button ${selectedOptions.includes(1) ? "selected" : ""}`} onClick={() => handleOptionClick(1)}>$</button>
        <button className={`button ${selectedOptions.includes(2) ? "selected" : ""}`} onClick={() => handleOptionClick(2)}>$$</button>
        <button className={`button ${selectedOptions.includes(3) ? "selected" : ""}`} onClick={() => handleOptionClick(3)}>$$$</button>
        <button className={`button ${selectedOptions.includes(4) ? "selected" : ""}`} onClick={() => handleOptionClick(4)}>$$$$</button>
      </div>
    </div>
